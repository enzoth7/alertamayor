...
function applyStep9(row, report) {
  ...
  return {
    ...
    publicly_approved: 0,
    official_sources_count: counts.official_sources || 0,
    public_maps_count: counts.public_maps || 0,
    public_social_sources_count: counts.public_social_sources || 0,
    other_public_sources_count: counts.other_public_sources || 0,
...
function applyClosure(row, closure) {
  ...
  return {
    ...
    official_sources_count: p.official_sources,
    public_maps_count: p.public_maps,
    public_social_sources_count: p.public_social_sources,
    other_public_sources_count: p.other_public_sources,
    manual_editorial_count: p.manual_editorial,
