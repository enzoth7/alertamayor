# Plan de implementación — Agente de WhatsApp de Alerta Mayor

**Estado:** sandbox técnico, inactivo y limitado a datos ficticios  
**Fecha de referencia:** 2026-08-04  
**Canal:** Chatwoot → n8n → API privada de Alerta Mayor → Supabase
...
El workflow original de Automotora no se modifica. El nuevo export está en `n8n/workflows/alerta-mayor-whatsapp-sandbox.json`, no contiene credenciales y se mantiene `active: false`.
...
ALERTA_MAYOR_BASE_URL=http://host.docker.internal:3000
